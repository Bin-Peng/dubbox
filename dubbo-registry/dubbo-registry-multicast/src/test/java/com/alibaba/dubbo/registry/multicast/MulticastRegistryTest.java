...
public class MulticastRegistryTest {
    ...
    EURL               registryUrl = EURL.valueOf("multicast://239.255.255.255/");
    EURL               serviceUrl  = EURL.valueOf("dubbo://" + NetUtils.getLocalHost() + "/" + service
                                                + "?methods=test1,test2");
    EURL               consumerUrl = EURL.valueOf("subscribe://" + NetUtils.getLocalHost() + "/" + service + "?arg1=1&arg2=2");
    ...
    public void testUrlerror() {
        EURL errorUrl = EURL.valueOf("multicast://mullticast/");
    ...
    public void testSubscribe() {
        // verify lisener.
        final AtomicReference<EURL> args = new AtomicReference<EURL>();
        ...
        Map<EURL, Set<NotifyListener>> arg = registry.getSubscribed();
    ...
    public void testDefaultPort() {
        MulticastRegistry multicastRegistry = new MulticastRegistry(EURL.valueOf("multicast://224.5.6.7"));
        try {
